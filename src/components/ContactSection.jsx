...
export const ContactSection = () => {
    ...
    return <section id="contact" className="py-24 px-4 relative bg-secondary/80">
                ...
                <div className="space-y-8 ">
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a href="https://www.linkedin.com/in/adilchaouch/" target="_blank"><Linkedin /></a>
                        </div>
                    </div>
                </div>
